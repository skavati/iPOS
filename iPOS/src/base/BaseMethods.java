...
public class BaseMethods {
	...
	public static WebDriver GetDriver(String BrowserName) {
		...
		try {
			...
			// default:
			// System.out.println("Sorry, invalid selection of ''Browser
			// name''.");
			// break;
			}
	...
	public static void GetDriver() {
		...
		GetDriver("IE"); // Using regular method overloads>>> as parameter url
							// has dynamic value "GlobalVariables.iPOSServer"
	}
	...
	public static void SwitchWindow(WebDriver driver, String Title, int WindowCount, int WaitTimeInSec)
		...
		try {
			...
			while ((driver.getWindowHandles().size()) != WindowCount) {
				...
				if (count == 30) {
					System.out.println("Window with title '" + Title + "' still not found even after  '" + WaitTimeInSec
							+ "' seconds");
					break;
				}
	...
	public static void WaitForElement(WebDriver driver, By by, int timeoutInSeconds) {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(by)); // method
																		// 2
																		// works
																		// for
																		// visible
	...
	public static void WaitForElement(WebDriver driver, By by) { // over load
																	// function
																	// to have
																	// default
																	// timeoutinSeconds=10
	...
	private static ExtentReports extent ;
	 public static ExtentReports getInstance() {
	        if (extent == null) {
	            extent = new ExtentReports("\\\\sydfps10\\cst\\QA\\Sarath Back up\\TestingHelper\\TestResultsReport.html", true) ; //\\sydfps10\cst\QA\Sarath Back up\TestingHelper\TestResultsReport.html
